...
// ─── Colección Firestore separada para Colombia ──────────────────
const BOLETOS_COL = 'boletos_colombia'

const PRICE_PER_TICKET = 20000

// ─── Componente principal ────────────────────────────────────────
export default function AppColombia() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--pink-bg)' }}>
      ...
      <div className="no-print" style={{ padding: '16px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
        ...
        <button
          id="btn-compartir-colombia"
          onClick={() => {
            const url = `${window.location.origin}/ver/colombia`
          ...
          <div style={{ padding: '0 20px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 8 }}>
              <div style={{
                ...
                <span style={{ color: '#222', fontWeight: 700, fontSize: 14 }}>Lotería de Risaralda</span>
              </div>
            </div>
            ...
            <div style={{
              ...
              <span style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '0 8px' }}>📅 Jueves 5 de junio</span>
              <span style={{ color: '#ccc' }}>|</span>
              <span style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '0 8px' }}>🕐 22:30h</span>
              <span style={{ color: '#ccc' }}>|</span>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 16 }}>
              ...
              <p style={{ fontSize: 16, fontWeight: 800, color: '#777', letterSpacing: 1, marginTop: 4 }}>
                20.000 COP
              </p>
            </div>
            ...
            <div style={{
              ...
              <InfoCard icon={<Ticket size={20} />} label="PRECIO" value="20.000 COP" valueSmall />
              <InfoCard icon={<CalendarDays size={20} />} label="SORTEO" value="5 de junio" />
              <InfoCard icon={<DollarSign size={20} />} label="PAGO" value="Nequi o efectivo" valueSmall />
              <InfoCard icon={<User size={20} />} label="ORGANIZA" value="Iris Cristina" />
            </div>
            ...
            <div className="contact-bar">
              ...
              <span style={{ fontSize: 18, letterSpacing: 2 }}>312 7539569</span>
            </div>
      ...
      {view === 'lista' && (
        <div style={{ maxWidth: 700, margin: '0 auto 32px', padding: '0 16px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(140px,1fr))', gap: 12, marginBottom: 24 }}>
            ...
            <StatCard
              label="Pendiente"
              value={`$${(totalExpected - totalCollected).toLocaleString('es-CO')}`}
          ...
          <div className="modal-card">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              {soldMap[modal] && (
                ...
                >
                  <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                    <XCircle size={16} /> Liberar Nº {String(modal).padStart(2, '00')}
                  </span>
                </button>
              )}
            </div>
